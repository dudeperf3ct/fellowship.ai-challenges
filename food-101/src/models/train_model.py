'''
This file is used to train a model using a base model
and save its weights to be further used for finetuning 
'''
...
val_generator = datagen.flow_from_directory(path,
                                            ...
                                            subset='validation',
                                            class_mode='categorical')
# get class mapping to index
label_map = (train_generator.class_indices)
# save this class mapping
...
model.save_weights(name+'_model-224_weights.h5')
